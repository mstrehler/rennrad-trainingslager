...
# will be automatically generated or updated. Never change eps file directly!
# SOURCE: contains the tex files.
...
# BIBCHECK: LaTeX files for generating a "all in" bib file (for control purposes)
# SOURCES: contains list of all tex files in SOURCE
