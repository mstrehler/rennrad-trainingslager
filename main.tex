% Datei: Documents/rennvelo/trainingswoche/main.tex
% Begonnen: 14.11.2015 
...
\begin{abstract}
Dieser Text beschreibt die Vorbereitung und Durchführung eines \rv-Traininglager zu Hause.
Dabei werden insbesondere die möglichen Nachteile eingegangen,
und wie diesen begegnet werden kann und allenfalls sogar als Vorteile genutzt werden können.
Das Ziel ist der optimale Nutzen für das Training für die aufgewendete Zeit.
\end{abstract}
...
Ein Vorschlag für eine Tagesplanung findet sich bei \citeNC{Boehme2016trainingstag}.
