...
% dass das Wort weiter getrennt wird. Begründung siehe:
% http://tex.stackexchange.com/questions/63232/why-can-words-with-hyphen-char-not-be-hyphenated/63234#63234
% Zitat:
% The T1 encoded fonts have in position 0x7F a character which is identical to the normal hyphen.
% Changing the \hyphenchar to denote this slot, the normal hyphen does not inhibit hyphenation any more
% Folgender Befehl ändert den Hyphen-Charakter.
