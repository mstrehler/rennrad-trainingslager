...
\renewcommand*\contentsname{Inhalt} % Standard: Inhaltsverzeichnis
...
Wenn man ein TL in gewohnter Umgebung durchführt, kommt noch ein weiterer Vorteil zum Tragen.
...
Das ausprobieren von neuen Strecken ohne Druck ist nach meiner Erfahrung ein grosser Motivationschub.
...
Bei \citeNP{DCRainmaker2018trainingplanzwift} findeet sich eine ausführliche Darstellung der
...
\begin{itemize}
        ...
        \item Regelmässig in den entsprechenden \rv"=Foren aktiv werden.
\end{itemize}
...
\bibliography{trainingslager.bib,roadbikebib/roadbike.bib}
